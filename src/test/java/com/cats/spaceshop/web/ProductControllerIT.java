...
@DisplayName("Products Controller IT using Repositories")
...
//        productDetailsDto = productMapper.entityToDto(productEntity);
//    }
//
//    @Test
...
//                .stockQuantity(productDetailsDto.getStockQuantity()+100)
...
//        UUID productId = productDetailsDto.getProductId();
...
//    @EnabledFeatureToggle(FeatureToggles.KITTY_PRODUCTS)
//    void getProductByCategory_ShouldReturnProductList() throws Exception {
//        Mockito.when(productService.findByCategory(UUID.randomUUID())).thenReturn(Optional.of(List.of(productDetailsDto)));
//
