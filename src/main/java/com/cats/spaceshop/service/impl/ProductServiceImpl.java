...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDetailsDto save(ProductCreateDto productCreateDto) {
        ProductEntity product = productMapper.toEntity(productCreateDto);
    ...
    public ProductDetailsDto update(ProductDetailsDto productDetailsDto) {
        ...
        ProductEntity newProduct = ProductEntity.builder()
            ...
            .name(existingProduct.getName() != null ? existingProduct.getName() : existingProduct.getName())
            .description(existingProduct.getDescription() != null ? existingProduct.getDescription() : existingProduct.getDescription())
            .price(existingProduct.getPrice() != null ? existingProduct.getPrice() : existingProduct.getPrice())
            .stockQuantity(existingProduct.getStockQuantity() != null ? existingProduct.getStockQuantity() : existingProduct.getStockQuantity())
            .categoryId(existingProduct.getCategoryId() != null ? existingProduct.getCategoryId() : existingProduct.getCategoryId())
            .build();
